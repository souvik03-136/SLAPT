...
describe("Lexer — drum block", () => {
  it("tokenizes drum block header with swing", () => {
  ...
  it("tokenizes kick pattern with decimal beats", () => {
  ...
  it("tokenizes kick on beats with and", () => {
  ...
  it("tokenizes snare on beats with and", () => {
  ...
  it("tokenizes hihat closed N times", () => {
  ...
  it("tokenizes snare velocity random range", () => {
...
describe("Lexer — chord block", () => {
  it("tokenizes chord progression with arrows", () => {
  ...
  it("tokenizes reverb effect call", () => {
...
describe("Lexer — atmosphere block", () => {
  it("tokenizes vinyl crackle line", () => {
...
describe("Lexer — general", () => {
  ...
  it("produces no errors on a full minimal program", () => {
...
drums with swing(60%):
  ...
  it("produces no errors on a full program with all blocks", () => {
    const code = `@genre lofi-hiphop
@tempo 72 bpm
@key Am
atmosphere:
