...
export const Identifier = createToken({
  name: "Identifier",
  // FIX: removed Unicode music symbols (♭♮) from pattern - they were showing as
  // mojibake (â™­ â™®) in some editors and confused the lexer. Plain ASCII is enough
  // for chord names like Am, F#, Bb (b suffix handled as plain letter).
...
// FIX: Removed Unicode → (U+2192) from Arrow token.
// Users had no way to type → on a standard keyboard.
// Now ONLY -> is supported - simple, typeable, unambiguous.
